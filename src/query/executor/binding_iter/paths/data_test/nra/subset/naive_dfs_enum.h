...
#ifndef MILLENNIUMDB_NRA_SUBSET_DFS_ENUM_H
#define MILLENNIUMDB_NRA_SUBSET_DFS_ENUM_H
...
namespace Paths::DataTest::NRA_SubsetOrder {
    ...
    class NaiveDFSEnum: public BindingIter {
    ...
    public:
        ...
        inline void set_iter(const SearchState& s) {
            ...
            s.dfs_iter = provider->get_iter(id.id, transition.inverse, s.path_state->node_id.id);
            idx_searches++;
        }
...
#endif //MILLENNIUMDB_NRA_SUBSET_DFS_ENUM_H
