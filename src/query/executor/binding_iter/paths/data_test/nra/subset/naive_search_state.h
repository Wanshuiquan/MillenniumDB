...
#ifndef NRA_SUBSET_SEARCH_STATE_H
#define NRA_SUBSET_SEARCH_STATE_H
...
template<>
struct std::hash<Paths::DataTest::NRA_SubsetOrder::SearchState> {
    std::size_t operator() (const Paths::DataTest::NRA_SubsetOrder::SearchState & lhs) const {
        std::size_t seed = 0;
...
#endif //NRA_SUBSET_SEARCH_STATE_H
