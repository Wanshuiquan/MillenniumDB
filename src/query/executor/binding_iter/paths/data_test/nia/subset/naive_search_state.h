...
#ifndef NIA_SUBSET_SEARCH_STATE_H
#define NIA_SUBSET_SEARCH_STATE_H
...
template<>
struct std::hash<Paths::DataTest::NIA_SubsetOrder::SearchState> {
    std::size_t operator() (const Paths::DataTest::NIA_SubsetOrder::SearchState & lhs) const {
        std::size_t seed = 0;
...
#endif //NIA_SUBSET_SEARCH_STATE_H
