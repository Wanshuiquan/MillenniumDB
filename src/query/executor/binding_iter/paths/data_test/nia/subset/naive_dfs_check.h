...
#ifndef MILLENNIUMDB_NIA_SUBSET_DFS_CHECK_H
#define MILLENNIUMDB_NIA_SUBSET_DFS_CHECK_H
#pragma  once
#include <stack>
...
namespace Paths::DataTest::NIA_SubsetOrder {
    ...
    class NaiveDFSCheck: public BindingIter {
    ...
    public:
        ...
        inline void set_iter(const SearchState& s) {
            ...
            auto& transition = automaton.from_to_connections[s.automaton_state][s.dfs_transition];
            s.dfs_iter = provider->get_iter(transition.type_id.id, transition.inverse, s.path_state-> node_id.id);
            idx_searches++;
        }
...
#endif //MILLENNIUMDB_NIA_SUBSET_DFS_CHECK_H
