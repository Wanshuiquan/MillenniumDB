...
void BindingIterPrinter::visit(EdgeTableLookup& binding_iter)
{
    ...
    os << "[" << binding_iter.edge << "]";
    if (binding_iter.from_assigned) {
        os << " [" << binding_iter.from << "]";
    }
    if (binding_iter.to_assigned) {
        os << " [" << binding_iter.to << "]";
    }
    if (binding_iter.type_assigned) {
        os << " [" << binding_iter.type << "]";
    }
    if (!binding_iter.from_assigned) {
        os << " " << binding_iter.from;
    }
...
void BindingIterPrinter::visit(EdgeTableLookupGQL& binding_iter)
{
    std::stringstream ss;
    ss << "lookups: " << binding_iter.lookups;
    auto helper = BindingIterPrinterHelper("EdgeTableLookupGQL", *this, binding_iter, ss.str());
...
void BindingIterPrinter::visit(SparqlService& binding_iter)
{
    ...
    ss << "requests: " << binding_iter.network_requests
       << ", "
          "total_request_time: "
       << binding_iter.response_parser.request_duration.count()
       << " ms, "
          "total_parse_time: "
       << binding_iter.response_parser.parse_duration.count() << " ms.";

    auto helper = BindingIterPrinterHelper("SparqlService", *this, binding_iter, ss.str());

    if (binding_iter.silent)
        os << "SILENT ";
...
void BindingIterPrinter::visit(TextSearchIndexScan& binding_iter)
{
    auto helper = BindingIterPrinterHelper("TextSearchIndexScan", *this, binding_iter);
    os << ")\n";
}
...
void BindingIterPrinter::visit(SetConstants& binding_iter)
{
    auto helper = BindingIterPrinterHelper("SetConstants", *this, binding_iter);

    bool first = true;
    for (auto& [var, oid] : binding_iter.var2oid) {
        if (first) {
            first = false;
        } else {
            os << ", ";
...
void BindingIterPrinter::visit(SetLabels& binding_iter)
{
    auto helper = BindingIterPrinterHelper("SetLabels", *this, binding_iter);
    bool first = true;
    for (auto& var : binding_iter.opt_labels) {
        if (first) {
            first = false;
        } else {
            os << ", ";
...
{
    std::stringstream ss;
    ss << "not nulls: " << binding_iter.found_not_nulls << ", nulls: " << binding_iter.found_nulls;
    auto helper = BindingIterPrinterHelper(
        "HashJoin::Generic::Hybrid::LeftJoin",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(HashJoin::Generic::InMemory::LeftJoin& binding_iter)
{
    ...
    ss << "not nulls: " << binding_iter.found_not_nulls << ", nulls: " << binding_iter.found_nulls;
    auto helper = BindingIterPrinterHelper(
        "HashJoin::Generic::InMemory::LeftJoin",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllShortest::BFSEnum<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllShortest::BFSEnum<false>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllShortest::BFSEnum<true>& binding_iter) {
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto
        helper = BindingIterPrinterHelper("Paths::AllShortest::BFSEnum<true>", *this, binding_iter, ss.str());
    os << ")\n";
}
...
{
    std::stringstream ss;
    ss << "idx_searches: " << binding_iter.idx_searches << ", paths_found: " << binding_iter.paths_found;
    auto
        helper = BindingIterPrinterHelper("Paths::AllShortestCount::BFSCheck", *this, binding_iter, ss.str());
    os << ")\n";
}
...
void BindingIterPrinter::visit(Paths::AllShortestCount::BFSEnum<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches << ", paths_found: " << binding_iter.paths_found;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllShortestCount::BFSEnum<false>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllShortestCount::BFSEnum<true>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches << ", paths_found: " << binding_iter.paths_found;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllShortestCount::BFSEnum<true>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllShortestSimple::BFSCheck<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllShortestSimple::BFSCheck<ACYCLIC>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllShortestSimple::BFSCheck<true>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllShortestSimple::BFSCheck<SIMPLE>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllShortestSimple::BFSEnum<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllShortestSimple::BFSEnum<ACYCLIC>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllShortestSimple::BFSEnum<true>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllShortestSimple::BFSEnum<SIMPLE>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllShortestTrails::BFSCheck& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllShortestTrails::BFSCheck",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllShortestTrails::BFSEnum& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto
        helper = BindingIterPrinterHelper("Paths::AllShortestTrails::BFSEnum", *this, binding_iter, ss.str());
    os << ")\n";
}
...
void BindingIterPrinter::visit(Paths::AllSimple::BFSCheck<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllSimple::BFSCheck<ACYCLIC>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllSimple::BFSCheck<true>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllSimple::BFSCheck<SIMPLE>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllSimple::BFSEnum<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllSimple::BFSEnum<ACYCLIC>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllSimple::BFSEnum<true>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto
        helper = BindingIterPrinterHelper("Paths::AllSimple::BFSEnum<SIMPLE>", *this, binding_iter, ss.str());
    os << ")\n";
}
...
void BindingIterPrinter::visit(Paths::AllSimple::DFSCheck<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllSimple::DFSCheck<ACYCLIC>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllSimple::DFSCheck<true>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllSimple::DFSCheck<SIMPLE>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllSimple::DFSEnum<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AllSimple::DFSEnum<ACYCLIC>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AllSimple::DFSEnum<true>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto
        helper = BindingIterPrinterHelper("Paths::AllSimple::DFSEnum<SIMPLE>", *this, binding_iter, ss.str());
    os << ")\n";
}
...
void BindingIterPrinter::visit(Paths::AnySimple::BFSCheck<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AnySimple::BFSCheck<ACYCLIC>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AnySimple::BFSCheck<true>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AnySimple::BFSCheck<SIMPLE>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AnySimple::BFSEnum<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AnySimple::BFSEnum<ACYCLIC>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AnySimple::BFSEnum<true>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto
        helper = BindingIterPrinterHelper("Paths::AnySimple::BFSEnum<SIMPLE>", *this, binding_iter, ss.str());
    os << ")\n";
}
...
void BindingIterPrinter::visit(Paths::AnySimple::DFSCheck<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AnySimple::DFSCheck<ACYCLIC>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AnySimple::DFSCheck<true>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AnySimple::DFSCheck<SIMPLE>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AnySimple::DFSEnum<false>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto helper = BindingIterPrinterHelper(
        "Paths::AnySimple::DFSEnum<ACYCLIC>",
        *this,
        binding_iter,
        ss.str()
    );
...
void BindingIterPrinter::visit(Paths::AnySimple::DFSEnum<true>& binding_iter)
{
    ...
    ss << "idx_searches: " << binding_iter.idx_searches;
    auto
        helper = BindingIterPrinterHelper("Paths::AnySimple::DFSEnum<SIMPLE>", *this, binding_iter, ss.str());
    os << ")\n";
}
