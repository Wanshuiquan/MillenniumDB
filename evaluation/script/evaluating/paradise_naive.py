...
Q11 = "DATA_TEST NAIVE?e (Officer {valid_until - ?p > 15 and ?p - valid_until < 15})/ ((:OFFICER_OF {true} )/(Entity {valid_until - ?p > 15 and ?p - valid_until < 15}))*"
Q12 = "DATA_TEST NAIVE?e (Officer {?p >= valid_until and ?q <= valid_until})/ ((:OFFICER_OF {true} )/(Entity {?p >= valid_until and ?q <= valid_until}))*"
Q13 = "DATA_TEST NAIVE?e (Officer {?p >= valid_until and ?q <= valid_until and ?q - ?p <= 7})/ ((:OFFICER_OF {true} )/(Entity {?p >= valid_until and ?q <= valid_until and ?q - ?p <= 7}))*"
Q14 = "DATA_TEST NAIVE?e (Officer {?p == valid_until and ?q == node_id })/ ((:OFFICER_OF {true} )/(Entity {?q - node_id <= 100 and node_id - ?q <= 100 and 0.5 * valid_until + 100 < ?p }))*"
Q15 = """DATA_TEST NAIVE?e (Officer {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100})/ ((:OFFICER_OF {true} )/ 
...
Q21 = """
        DATA_TEST NAIVE?e (Officer {valid_until - ?p > 15 and ?p - valid_until < 15})/ 
...
Q22 = """ 
       DATA_TEST NAIVE?e (Officer {?p >= valid_until and ?q <= valid_until})/ 
...
Q23 = """ 
       DATA_TEST NAIVE?e (Officer {?p >= valid_until and ?q <= valid_until and ?p - ?q <= 7})/ 
...
Q24 = """ 
       DATA_TEST NAIVE?e (Officer {?p == valid_until and ?q == node_id})/ 
...
Q25 = """ 
       DATA_TEST NAIVE?e (Officer {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100})/ 
...
"""
Q31 =  """
        DATA_TEST NAIVE?e (Officer {true})/ 
...
"""
Q33 = """ 
       DATA_TEST NAIVE?e (Officer {?p >= node_id and ?q <= node_id and ?p -?q <= 7})/ 
...
"""
Q35 = """ 
       DATA_TEST NAIVE?e (Officer {?q - valid_until + ?p - node_id <= 100 and valid_until - ?q + ?p - node_id <= 100 and valid_until - ?q + node_id - ?p <= 100 and ?q - valid_until + node_id - ?p <= 100})/ 
...
Q91 = "DATA_TEST NAIVE?e (Officer {valid_until - ?p > 15 and ?p - valid_until < 15 })/ (((:OFFICER_OF {true}) | (:REGISTERED_ADDRESS {true} ) | (INTERMEDIARY_OF {true} ))/(Entity {valid_until - ?p > 15 and ?p - valid_until < 15}))*"
Q92 = "DATA_TEST NAIVE?e (Officer {?p >= valid_until and ?q <= valid_until})/ (((:OFFICER_OF {true}) | (:REGISTERED_ADDRESS {true} ) | (INTERMEDIARY_OF {true} ))/(Entity {?p >= valid_until and ?q <= valid_until}))*"
Q93 = "DATA_TEST NAIVE?e (Officer {?p >= valid_until and ?q <= valid_until and ?p - ?q <= 7})/ (((:OFFICER_OF {true}) | (:REGISTERED_ADDRESS {true} ) | (:INTERMEDIARY_OF {true} ))/(Entity {?p >= valid_until and ?q <= valid_until and ?p - ?q <= 7}))*"
Q94 = "DATA_TEST NAIVE?e (Officer {?p == valid_until and ?q == node_id})/ (((:OFFICER_OF {true}) | (:REGISTERED_ADDRESS {true} ) | (:INTERMEDIARY_OF {true} ))/(Entity {?q - node_id <= 100 and node_id - ?q <= 100 and 0.5 * valid_until + 100 <= ?p}))*"
Q95 = "DATA_TEST NAIVE?e (Officer {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100})/ (((:OFFICER_OF {true}) | (:REGISTERED_ADDRESS {true} ) | (:INTERMEDIARY_OF {true} ))/(Entity {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100}))*"


Q101 = "DATA_TEST NAIVE?e (Officer {valid_until - ?p > 15 and ?p - valid_until < 15})/ (((:OFFICER_OF {true}) | (:REGISTERED_ADDRESS {true} ) | (INTERMEDIARY_OF {true} ))/(Entity {valid_until - ?p > 15 and ?p - valid_until < 15}))/((INTERMEDIARY_OF {true} )/(Intermediary {valid_until - ?p > 15 and ?p - valid_until < 15}))*"
Q102 = "DATA_TEST NAIVE?e (Officer {?p >= valid_until and ?q <= valid_until})/ (((:OFFICER_OF {true}) | (:REGISTERED_ADDRESS {true} ) | (INTERMEDIARY_OF {true} ))/(Entity {?p >= valid_until and ?q <= valid_until}))/(INTERMEDIARY_OF {true} )/((Intermediary {?p >= valid_until and ?q <= valid_until}))*"
Q103 = "DATA_TEST NAIVE?e (Officer {?p >= valid_until and ?q <= valid_until and ?p - ?q <= 7})/ (((:OFFICER_OF {true}) | (:REGISTERED_ADDRESS {true} ) | (:INTERMEDIARY_OF {true} ))/(Entity {?p >= valid_until and ?q <= valid_until and ?p - ?q <= 7}))*"
Q104 = "DATA_TEST NAIVE?e (Officer {?p >= valid_until and ?q == node_id})/ (((:OFFICER_OF {true}) | (:REGISTERED_ADDRESS {true} ) | (:INTERMEDIARY_OF {true} ))/(Entity {?q - node_id <= 100 and node_id - ?q <= 100 and 0.5 * valid_until + 100 <= ?p}))*"
Q105 = "DATA_TEST NAIVE?e (Officer {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100})/ ((((:OFFICER_OF {true}) | (:REGISTERED_ADDRESS {true} ) | (:INTERMEDIARY_OF {true} ))/(Entity {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100})))*"
...
def icij_graph_query():
    ...
    kill_server(server)
    with open(ROOT_TEST_DIR / "result" / "icij_paradise_naive_static.pkl", "wb") as fb:
        pickle.dump(result, fb)

    with open(ROOT_TEST_DIR / "result" / "icij_paradise_naive_result.pkl", "wb") as fb:
