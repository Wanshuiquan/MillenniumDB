...
Q51 = "DATA_TEST NAIVE ?e (Entity {valid_until - ?p > 15 and ?p - valid_until < 15})/ ((:same_as {true} )/(Entity {valid_until - ?p > 15 and ?p - valid_until < 15}))+"
Q52 = "DATA_TEST NAIVE ?e (Entity {?p >= valid_until and ?q <= valid_until})/ ((:same_as {true} )/(Entity {?p >= valid_until and ?q <= valid_until}))+"
Q53 = "DATA_TEST NAIVE ?e (Entity {?p >= valid_until and ?q <= valid_until and ?q - ?p <= 7})/ ((:same_as {true} )/(Entity {?p >= valid_until and ?q <= valid_until and ?q - ?p <= 7}))+"
Q54 = "DATA_TEST NAIVE ?e (Entity {?p == valid_until and ?q == node_id })/ ((:same_as {true} )/(Entity {?q - node_id <= 100 and node_id - ?q <= 100 and 0.5 * valid_until + 100 < ?p }))+"
Q55 = """DATA_TEST NAIVE ?e (Entity {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100})/ ((:same_as {true} )/ 
(Entity {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100 }))+"""
