...
TEMPLATE_Q100 = "ANY ACYCLIC ?e (:same_as | :same_name_as | underlying)/:same_name_as*"

Q11 = "DATA_TEST  NAIVE ?e (Entity {valid_until - ?p > 15 and ?p - valid_until < 15})/ ((:same_as {true} )/(Entity {valid_until - ?p > 15 and ?p - valid_until < 15}))*"
Q12 = "DATA_TEST  NAIVE ?e (Entity {?p >= valid_until and ?q <= valid_until})/ ((:same_as {true} )/(Entity {?p >= valid_until and ?q <= valid_until}))*"
Q13 = "DATA_TEST  NAIVE ?e (Entity {?p >= valid_until and ?q <= valid_until and ?q - ?p <= 7})/ ((:same_as {true} )/(Entity {?p >= valid_until and ?q <= valid_until and ?q - ?p <= 7}))*"
Q14 = "DATA_TEST  NAIVE ?e (Entity {?p == valid_until and ?q == node_id })/ ((:same_as {true} )/(Entity {?q - node_id <= 100 and node_id - ?q <= 100 and 0.5 * valid_until + 100 < ?p }))*"
Q15 = """DATA_TEST  NAIVE ?e (Entity {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100})/ ((:same_as {true} )/ 
...
Q23 = """ 
       DATA_TEST  NAIVE ?e (Entity {?p >= valid_until and ?q <= valid_until and ?p - ?q <= 7})/ 
...
Q24 = """ 
       DATA_TEST  NAIVE ?e (Entity {?p == valid_until and ?q == node_id})/ 
...
Q25 = """ 
       DATA_TEST  NAIVE ?e (Entity {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100})/ 
...
"""
Q33 = """ 
       DATA_TEST  NAIVE ?e (Entity {?p >= node_id and ?q <= node_id and ?p -?q <= 7})/ 
                ((:same_as {true} )/(Entity {?p >= node_id and ?q <= node_id and ?p - ?q <= 7}))?/
                 ((:same_name_as {true} )/(Entity {?p >= node_id and ?q <= node_id and ?p -?q <= 7}))*
"""


Q34 = """ 
       DATA_TEST  NAIVE ?e (Entity {?p == node_id and ?q == valid_until})/ 
                ((:same_as {true} )/(Entity {?q - valid_until <= 100 and valid_until - ?q <= 100 and 0.5 * node_id + 100 < ?p}))?/
                 ((:same_name_as {true} )/(Entity {?q - valid_until <= 100 and valid_until - ?q <= 100 and 0.5 * node_id + 100 < ?p}))*
"""
Q35 = """ 
       DATA_TEST  NAIVE ?e (Entity {?q - valid_until + ?p - node_id <= 100 and valid_until - ?q + ?p - node_id <= 100 and valid_until - ?q + node_id - ?p <= 100 and ?q - valid_until + node_id - ?p <= 100})/ 
                ((:same_as {true} )/(Entity {?q - valid_until + ?p - node_id <= 100 and valid_until - ?q + ?p - node_id <= 100 and valid_until - ?q + node_id - ?p <= 100 and ?q - valid_until + node_id - ?p <= 100}))?/
                 ((:same_name_as {true} )/(Entity {?q - valid_until + ?p - node_id <= 100 and valid_until - ?q + ?p - node_id <= 100 and valid_until - ?q + node_id - ?p <= 100 and ?q - valid_until + node_id - ?p <= 100}))*
"""
...
Q91 = "DATA_TEST  NAIVE ?e (Entity {valid_until - ?p > 15 and ?p - valid_until < 15 })/ (((:same_as {true}) | (:same_name_as {true} ) | (underlying {true} ))/(Entity {valid_until - ?p > 15 and ?p - valid_until < 15}))*"
Q92 = "DATA_TEST  NAIVE ?e (Entity {?p >= valid_until and ?q <= valid_until})/ (((:same_as {true}) | (:same_name_as {true} ) | (underlying {true} ))/(Entity {?p >= valid_until and ?q <= valid_until}))*"
Q93 = "DATA_TEST  NAIVE ?e (Entity {?p >= valid_until and ?q <= valid_until and ?p - ?q <= 7})/ (((:same_as {true}) | (:same_name_as {true} ) | (:underlying {true} ))/(Entity {?p >= valid_until and ?q <= valid_until and ?p - ?q <= 7}))*"
Q94 = "DATA_TEST  NAIVE ?e (Entity {?p == valid_until and ?q == node_id})/ (((:same_as {true}) | (:same_name_as {true} ) | (:underlying {true} ))/(Entity {?q - node_id <= 100 and node_id - ?q <= 100 and 0.5 * valid_until + 100 <= ?p}))*"
Q95 = "DATA_TEST  NAIVE ?e (Entity {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100})/ (((:same_as {true}) | (:same_name_as {true} ) | (:underlying {true} ))/(Entity {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100}))*"

Q101 = "DATA_TEST  NAIVE ?e (Entity {valid_until - ?p > 15 and ?p - valid_until < 15})/ (((:same_as {true}) | (:same_name_as {true} ) | (underlying {true} ))/(Entity {valid_until - ?p > 15 and ?p - valid_until < 15}))/((underlying {true} )/(Entity {valid_until - ?p > 15 and ?p - valid_until < 15}))*"
Q102 = "DATA_TEST  NAIVE ?e (Entity {?p >= valid_until and ?q <= valid_until})/ (((:same_as {true}) | (:same_name_as {true} ) | (underlying {true} ))/(Entity {?p >= valid_until and ?q <= valid_until}))/(underlying {true} )/((Entity {?p >= valid_until and ?q <= valid_until}))*"
Q103 = "DATA_TEST  NAIVE ?e (Entity {?p >= valid_until and ?q <= valid_until and ?p - ?q <= 7})/ (((:same_as {true}) | (:same_name_as {true} ) | (:underlying {true} ))/(Entity {?p >= valid_until and ?q <= valid_until and ?p - ?q <= 7}))*"
Q104 = "DATA_TEST  NAIVE ?e (Entity {?p >= valid_until and ?q == node_id})/ (((:same_as {true}) | (:same_name_as {true} ) | (:underlying {true} ))/(Entity {?q - node_id <= 100 and node_id - ?q <= 100 and 0.5 * valid_until + 100 <= ?p}))*"
Q105 = "DATA_TEST  NAIVE ?e (Entity {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100})/ ((((:same_as {true}) | (:same_name_as {true} ) | (:underlying {true} ))/(Entity {?q - node_id + ?p - valid_until <= 100 and node_id - ?q + ?p - valid_until <= 100 and node_id - ?q + valid_until - ?p <= 100 and ?q - node_id + valid_until - ?p <= 100})))*"
...
def icij_graph_query():
    ...
    kill_server(server)
    with open(ROOT_TEST_DIR / "result" / "icij_leak_naive_static.pkl", "wb") as fb:
