...
TEMPLATE_Q15 = "ANY ACYCLIC ?e :same_as*/:same_name_as*"
...
REGEX_TEMPLATE = [TEMPLATE_Q1, TEMPLATE_Q2, TEMPLATE_Q3, TEMPLATE_Q4, TEMPLATE_Q15, TEMPLATE_Q6, TEMPLATE_Q7, TEMPLATE_Q8, TEMPLATE_Q9, TEMPLATE_Q10]
...
def icij_graph_query():
    ...
    candidate = send_query(f"Match (?x:Entity) Return * Limit {ICIJ_LEAK_SAMPLE}").split("\n")[1:-1]
    result = []
    query_res = []
    # dating query
