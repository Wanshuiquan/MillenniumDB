...
Q51 = "DATA_TEST ?e (person {oid - ?p > 15 and ?p - oid < 15})/ ((:knows {true} )/(person {oid - ?p > 15 and ?p - oid < 15}))+"
Q52 = "DATA_TEST ?e (person {?p >= oid and ?q <= oid})/ ((:knows {true} )/(person {?p >= oid and ?q <= oid}))+"
Q53 = "DATA_TEST ?e (person {?p >= oid and ?q <= oid and ?q - ?p <= 7})/ ((:knows {true} )/(person {?p >= oid and ?q <= oid and ?q - ?p <= 7}))+"
Q54 = "DATA_TEST ?e (person {?p == oid and ?q == iid })/ ((:knows {true} )/(person {?q - iid <= 100 and iid - ?q <= 100 and 0.5 * oid + 100 < ?p }))+"
Q55 = """DATA_TEST ?e (person {?q - iid + ?p - oid <= 100 and iid - ?q + ?p - oid <= 100 and iid - ?q + oid - ?p <= 100 and ?q - iid + oid - ?p <= 100})/ ((:knows {true} )/ 
(person {?q - iid + ?p - oid <= 100 and iid - ?q + ?p - oid <= 100 and iid - ?q + oid - ?p <= 100 and ?q - iid + oid - ?p <= 100 }))+"""
