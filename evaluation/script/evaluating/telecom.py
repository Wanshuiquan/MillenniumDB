...
Q12 = "DATA_TEST ?e (cell {?p >= attr1 and ?q <= attr1})/ ((:lived {true} )/(user {?p >= attr1 and ?q <= attr1}))*"
Q13 = "DATA_TEST ?e (cell {?p >= attr1 and ?q <= attr1 and ?q - ?p <= 0.7})/ ((:lived {true} )/(user {?p >= attr1 and ?q <= attr1 and ?q - ?p <= 0.7}))*"
Q14 = "DATA_TEST ?e (cell {?p == attr1 and ?q == attr2 })/ ((:lived {true} )/(user {?q - attr2 <= 0.1 and attr2 - ?q <= 0.1 and 0.5 * attr1 + 0.1 < ?p }))*"
...
Q22 = """ 
       DATA_TEST ?e (cell {?p >= attr1 and ?q <= attr1})/ 
...
Q25 = """ 
       DATA_TEST ?e (cell {?q - attr2 + ?p - attr1 <= 0.1 and attr2 - ?q + ?p - attr1 <= 0.1 and attr2 - ?q + attr1 - ?p <= 0.1 and ?q - attr2 + attr1 - ?p <= 0.1})/ 
...
Q45 = "DATA_TEST ?e (cell {?q - attr2 + ?p - attr1 <= 0.1 and attr2 - ?q + ?p - attr1 <= 0.1 and attr2 - ?q + attr1 - ?p <= 0.1 and ?q - attr2 + attr1 - ?p <= 0.1})/ (((:lived {true}) | (:used {true} ) | (:bought {true} ))/(user {?q - attr2 + ?p - attr1 <= 0.1 and attr2 - ?q + ?p - attr1 <= 0.1 and attr2 - ?q + attr1 - ?p <= 0.1 and ?q - attr2 + attr1 - ?p <= 0.1}))*"

Q51 = "DATA_TEST ?e (cell {attr1 - ?p > 0.3 and ?p - attr1 < 0.3})/ ((:lived {true} )/(user {attr1 - ?p > 0.3 and ?p - attr1 < 0.3}))+"
Q52 = "DATA_TEST ?e (cell {?p >= attr1 and ?q <= attr1})/ ((:lived {true} )/(user {?p >= attr1 and ?q <= attr1}))+"
Q53 = "DATA_TEST ?e (cell {?p >= attr1 and ?q <= attr1 and ?q - ?p <= 0.7})/ ((:lived {true} )/(user {?p >= attr1 and ?q <= attr1 and ?q - ?p <= 0.7}))+"
Q54 = "DATA_TEST ?e (cell {?p == attr1 and ?q == attr2 })/ ((:lived {true} )/(user {?q - attr2 <= 0.1 and attr2 - ?q <= 0.1 and 0.5 * attr1 + 0.1 < ?p }))+"
