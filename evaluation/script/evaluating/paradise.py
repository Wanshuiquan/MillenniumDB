...
Q11 = "DATA_TEST ?e (Officer {node_id - ?p > 0.3 and ?p - node_id < 0.3})/ ((:OFFICER_OF {true} )/(Entity {node_id - ?p > 0.3 and ?p - node_id < 0.3}))*"
Q12 = "DATA_TEST ?e (Officer {?p >= node_id and ?q <= node_id})/ ((:OFFICER_OF {true} )/(Entity {?p >= node_id and ?q <= node_id}))*"
Q13 = "DATA_TEST ?e (Officer {?p >= node_id and ?q <= node_id and ?q - ?p <= 0.7})/ ((:OFFICER_OF {true} )/(Entity {?p >= node_id and ?q <= node_id and ?q - ?p <= 0.7}))*"
Q14 = "DATA_TEST ?e (Officer {?p == node_id and ?q == valid_until })/ ((:OFFICER_OF {true} )/(Entity {?q - valid_until <= 0.1 and valid_until - ?q <= 0.1 and 0.5 * node_id + 0.1 < ?p }))*"
Q15 = """DATA_TEST ?e (Officer {?q - valid_until + ?p - node_id <= 0.1 and valid_until - ?q + ?p - node_id <= 0.1 and valid_until - ?q + node_id - ?p <= 0.1 and ?q - valid_until + node_id - ?p <= 0.1})/ ((:OFFICER_OF {true} )/ 
...
Q23 = """ 
       DATA_TEST ?e (Officer {?p >= node_id and ?q <= node_id and ?p - ?q <= 0.7})/ 
...
Q25 = """ 
       DATA_TEST ?e (Officer {?q - valid_until + ?p - node_id <= 0.1 and valid_until - ?q + ?p - node_id <= 0.1 and valid_until - ?q + node_id - ?p <= 0.1 and ?q - valid_until + node_id - ?p <= 0.1})/ 
...
Q51 = "DATA_TEST ?e (Officer {node_id - ?p > 0.3 and ?p - node_id < 0.3})/ ((:OFFICER_OF {true} )/(Entity {node_id - ?p > 0.3 and ?p - node_id < 0.3}))+"
Q52 = "DATA_TEST ?e (Officer {?p >= node_id and ?q <= node_id})/ ((:OFFICER_OF {true} )/(Entity {?p >= node_id and ?q <= node_id}))+"
Q53 = "DATA_TEST ?e (Officer {?p >= node_id and ?q <= node_id and ?q - ?p <= 0.7})/ ((:OFFICER_OF {true} )/(Entity {?p >= node_id and ?q <= node_id and ?q - ?p <= 0.7}))+"
Q54 = "DATA_TEST ?e (Officer {?p == node_id and ?q == valid_until })/ ((:OFFICER_OF {true} )/(Entity {?q - valid_until <= 0.1 and valid_until - ?q <= 0.1 and 0.5 * node_id + 0.1 < ?p }))+"
Q55 = """DATA_TEST ?e (Officer {?q - valid_until + ?p - node_id <= 0.1 and valid_until - ?q + ?p - node_id <= 0.1 and valid_until - ?q + node_id - ?p <= 0.1 and ?q - valid_until + node_id - ?p <= 0.1})/ ((:OFFICER_OF {true} )/ 
(Entity {?q - valid_until + ?p - node_id <= 0.1 and valid_until - ?q + ?p - node_id <= 0.1 and valid_until - ?q + node_id - ?p <= 0.1 and ?q - valid_until + node_id - ?p <= 0.1 }))+"""
...
def icij_graph_query():
    ...
    kill_server(server)
    with open(ROOT_TEST_DIR / "result" / "icij_paradise_statistic.json", "w") as fb:
        json.dump(result, fb)

    with open(ROOT_TEST_DIR / "result" / "icij_paradise_result.json", "w") as fb:
