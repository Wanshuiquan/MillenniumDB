...
Q11 = "DATA_TEST NAIVE ?e (Person {id - ?p > 15 and ?p - id < 15})/ ((:KNOWS {true} )/(Person {id - ?p > 15 and ?p - id < 15}))*"
Q12 = "DATA_TEST NAIVE ?e (Person {?p >= id and ?q <= id})/ ((:KNOWS {true} )/(Person {?p >= id and ?q <= id}))*"
Q13 = "DATA_TEST NAIVE ?e (Person {?p >= id and ?q <= id and ?q - ?p <= 7})/ ((:KNOWS {true} )/(Person {?p >= id and ?q <= id and ?q - ?p <= 7}))*"
Q14 = "DATA_TEST NAIVE ?e (Person {?p == id and ?q == uid })/ ((:KNOWS {true} )/(Person {?q - uid <= 100 and uid - ?q <= 100 and 0.5 * id + 100 < ?p }))*"
Q15 = """DATA_TEST NAIVE ?e (Person {?q - uid + ?p - id <= 100 and uid - ?q + ?p - id <= 100 and uid - ?q + id - ?p <= 100 and ?q - uid + id - ?p <= 100})/ ((:KNOWS {true} )/ 
...
Q51 = "DATA_TEST NAIVE ?e (Person {id - ?p > 15 and ?p - id < 15})/ ((:KNOWS {true} )/(Person {id - ?p > 15 and ?p - id < 15}))+"
Q52 = "DATA_TEST NAIVE ?e (Person {?p >= id and ?q <= id})/ ((:KNOWS {true} )/(Person {?p >= id and ?q <= id}))+"
Q53 = "DATA_TEST NAIVE ?e (Person {?p >= id and ?q <= id and ?q - ?p <= 7})/ ((:KNOWS {true} )/(Person {?p >= id and ?q <= id and ?q - ?p <= 7}))+"
Q54 = "DATA_TEST NAIVE ?e (Person {?p == id and ?q == uid })/ ((:KNOWS {true} )/(Person {?q - uid <= 100 and uid - ?q <= 100 and 0.5 * id + 100 < ?p }))+"
Q55 = """DATA_TEST NAIVE ?e (Person {?q - uid + ?p - id <= 100 and uid - ?q + ?p - id <= 100 and uid - ?q + id - ?p <= 100 and ?q - uid + id - ?p <= 100})/ ((:KNOWS {true} )/ 
(Person {?q - uid + ?p - id <= 100 and uid - ?q + ?p - id <= 100 and uid - ?q + id - ?p <= 100 and ?q - uid + id - ?p <= 100 }))+"""
...
def icij_graph_query():
    ...
    for template_index in range(12):
        ...
        kill_server(server)
       #  file_handler("ldbc10",f"Q{template_index}", "naive", "candidate")
        ...
        file_handler("ldbc10",f"Q{template_index}", "naive", "no-data")
        kill_server(server)
        ...
        for query in rdpq_templates:
              # money query 
                     ...
                     file_handler("ldbc10", f"Q{template_index}", "naive", f"data-{query_index}")
