...
Q11 = "DATA_TEST NAIVE ?e (people {AGE - ?p > 15 and ?p - AGE < 15})/ ((:Follow {true} )/(people {AGE - ?p > 15 and ?p - AGE < 15}))*"
Q12 = "DATA_TEST NAIVE ?e (people {?p >= AGE and ?q <= AGE})/ ((:Follow {true} )/(people {?p >= AGE and ?q <= AGE}))*"
Q13 = "DATA_TEST NAIVE ?e (people {?p >= AGE and ?q <= AGE and ?q - ?p <= 7})/ ((:Follow {true} )/(people {?p >= AGE and ?q <= AGE and ?q - ?p <= 7}))*"
Q14 = "DATA_TEST NAIVE ?e (people {?p == AGE and ?q == completion_percentage })/ ((:Follow {true} )/(people {?q - completion_percentage <= 100 and completion_percentage - ?q <= 100 and 0.5 * AGE + 100 < ?p }))*"
...
Q24 = """ 
       DATA_TEST NAIVE ?e (people {?p == AGE and ?q == completion_percentage})/ 
...
Q25 = """ 
       DATA_TEST NAIVE ?e (people {?q - completion_percentage + ?p - AGE <= 100 and completion_percentage - ?q + ?p - AGE <= 100 and completion_percentage - ?q + AGE - ?p <= 100 and ?q - completion_percentage + AGE - ?p <= 100})/ 
...
Q51 = "DATA_TEST NAIVE ?e (people {AGE - ?p > 15 and ?p - AGE < 15})/ ((:Follow {true} )/(people {AGE - ?p > 15 and ?p - AGE < 15}))+"
Q52 = "DATA_TEST NAIVE ?e (people {?p >= AGE and ?q <= AGE})/ ((:Follow {true} )/(people {?p >= AGE and ?q <= AGE}))+"
Q53 = "DATA_TEST NAIVE ?e (people {?p >= AGE and ?q <= AGE and ?q - ?p <= 7})/ ((:Follow {true} )/(people {?p >= AGE and ?q <= AGE and ?q - ?p <= 7}))+"
Q54 = "DATA_TEST NAIVE ?e (people {?p == AGE and ?q == completion_percentage })/ ((:Follow {true} )/(people {?q - completion_percentage <= 100 and completion_percentage - ?q <= 100 and 0.5 * AGE + 100 < ?p }))+"
